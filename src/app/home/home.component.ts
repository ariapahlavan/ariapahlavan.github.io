...
export class HomeComponent implements OnInit {
  ...
  timelineContent: TimelineContent[] = [
    ...
    {event: 'Transferred to The University of Texas at Austin', icon: '🏫', date: 'Aug 2014', link: 'https://en.wikipedia.org/wiki/University_of_Texas_at_Austin'},
    {event: 'Went to Collin College', icon: '🏫', date: 'Jan 2012', link: 'https://en.wikipedia.org/wiki/Collin_College'},
    {event: 'Moved to US', icon: '✈️', date: 'Nov 2011', link: '#'},
    {event: 'Went to Firooz Bahram High School', icon: '🏫', date: '', link: 'https://en.wikipedia.org/wiki/Firooz_Bahram_High_School'},
